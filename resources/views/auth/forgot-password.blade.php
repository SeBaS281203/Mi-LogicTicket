        ...
        <div class="bg-white rounded-2xl shadow-xl border border-neutral-100 p-6 sm:p-8">
            ...
            @if(session('status'))
                <div class="mb-6 p-4 bg-violet-50 border border-violet-100 text-violet-700 rounded-xl text-sm flex items-start gap-3">
                    <svg class="w-5 h-5 text-violet-50000 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    {{ session('status') }}
                </div>
            @endif
