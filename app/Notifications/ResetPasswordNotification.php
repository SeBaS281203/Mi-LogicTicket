...
class ResetPasswordNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Recuperar contraseña - ChiclayoTicket')
            ->greeting('¡Hola!')
            ->line('Recibiste este correo porque solicitaste un restablecimiento de contraseña para tu cuenta en ChiclayoTicket.')
